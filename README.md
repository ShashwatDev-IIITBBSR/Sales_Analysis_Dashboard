...
## Created & Analyzed by Shashwat Dev Data Analyst @MAQ Software [Linkedin](https://www.linkedin.com/in/shashwat-dev/)

#

## Project Objective

The primary objective of this project is to develop a comprehensive and visually appealing Power BI dashboard that analyzes the medicine sales data for the entire year of 2023 and 2022. It should be short and to the point so that user can understand all important metrics at a glane.
...
## Dashboard Overview
Based on the project objective, I have developed a two-page Power BI dashboard report to analyze and visualize the medicine sales data for 2023. I didn't want the dashboard to be long or difficult to understand. As a data analyst I want dashboard to be as simple as possible but at the same time it should provide maximum value to user.
...
![Screenshot 2024-07-25 230006](https://github.com/user-attachments/assets/27229bfd-d1d3-4ef9-8562-5eb3616243ed)
...
![Screenshot 2024-07-25 230312](https://github.com/user-attachments/assets/5911141d-985a-4e35-9257-58576d9dd002)

This page provides key insights into customer demographics and sales performance across various segments. It includes essential KPIs and visualizations to help stakeholders understand customer behaviour and geographic trends.
...
#
## Slicers Panel
![Screenshot 2024-07-25 230713](https://github.com/user-attachments/assets/b9133b53-b6e8-4921-a830-9e1251f5a9ed)

Slicers panel helps user to slice data as per their wish. User can close slicer panel by clicking on red cross button.

After closing the slicer panel, user can clear all slicer by clicing on bottom left icon.
...
## My Learnings:
I am pleased to share that my experience at MAQ Software has enabled me to transform raw data into meaningful insights that drive strategic business decisions. This opportunity has equipped me well for future data analysis projects, and I am eager to apply these skills in more complex and challenging scenarios.
#
**This project is the result of over 3-4 days of hard work, and I invite you to 👍 like, share, and connect with me on [Linkedin](https://www.linkedin.com/in/shashwat-dev/).**
...
Shashwat Dev Data Analyst @MAQ Software [Linkedin](https://www.linkedin.com/in/shashwat-dev/)
